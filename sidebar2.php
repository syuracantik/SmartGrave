<aside class="w-72 sidebar-premium text-white hidden lg:flex flex-col shadow-2xl sticky top-0 h-screen">
    <div class="p-8">
        ...
        <nav class="space-y-3">
            <a href="admin_dashboard.php" class="flex items-center space-x-4 p-4 bg-emerald-700/40 rounded-2xl text-white font-bold border border-emerald-600/50">
                <i class="fas fa-th-large"></i> <span>Dashboard</span>
            </a>
            <a href="susun_lot.php" class="flex items-center space-x-4 p-4 hover:bg-emerald-800/50 rounded-2xl transition text-emerald-100/70">
                <i class="fas fa-file-contract"></i> <span>Susun Atur Lot</span>
            </a>
            <a href="data_khairat.php" class="flex items-center space-x-4 p-4 hover:bg-emerald-800/50 rounded-2xl transition text-emerald-100/70">
